...
public interface gListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterTypeInteger(gParser.TypeIntegerContext ctx);
	/**
	 * Exit a parse tree produced by the {@code TypeInteger}
	 * labeled alternative in {@link gParser#type}.
	 * @param ctx the parse tree
	 */
	void exitTypeInteger(gParser.TypeIntegerContext ctx);
	/**
	 * Enter a parse tree produced by the {@code TypeBoolean}
	 * labeled alternative in {@link gParser#type}.
	 * @param ctx the parse tree
	 */
	void enterTypeBoolean(gParser.TypeBooleanContext ctx);
	/**
	 * Exit a parse tree produced by the {@code TypeBoolean}
	 * labeled alternative in {@link gParser#type}.
	 * @param ctx the parse tree
	 */
	void exitTypeBoolean(gParser.TypeBooleanContext ctx);
	/**
	 * Enter a parse tree produced by the {@code BlockStat}
	 * labeled alternative in {@link gParser#block}.
	 * @param ctx the parse tree
	 */
	void enterBlockStat(gParser.BlockStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code BlockStat}
	 * labeled alternative in {@link gParser#block}.
	 * @param ctx the parse tree
	 */
	void exitBlockStat(gParser.BlockStatContext ctx);
	/**
	 * Enter a parse tree produced by the {@code BlockParentStat}
	 * labeled alternative in {@link gParser#block}.
	 * @param ctx the parse tree
	 */
	void enterBlockParentStat(gParser.BlockParentStatContext ctx);
	/**
	 * Exit a parse tree produced by the {@code BlockParentStat}
	 * labeled alternative in {@link gParser#block}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterListAExpr(gParser.ListAExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ListAExpr}
	 * labeled alternative in {@link gParser#lAexpression}.
	 * @param ctx the parse tree
	 */
	void exitListAExpr(gParser.ListAExprContext ctx);
	/**
